...
filter_procedure = [
    ...
    # EBITDA + 特定条件
    {
        ...
        "threshold": True,
        "period": "3Y",
        "description": "EBITDA 三年非负，复合增速 > 5% 3Y (资产大规模增长除外)"
    },
    ...
    # 扣非净利润 + 特定条件
    {
        ...
        "threshold": True,
        "period": "3Y",
        "description": "扣非净利润 复合增速 > 5% 3Y (资产大规模增长除外)"
    },
    ...
    # OCF增长率
    {
        ...
        "fields_arithmetic": {'dfarithmetic': ['/'], 'all':'(calculate_df > 0.2)'},
        "sgn": "==",
        "threshold": True,
        "period": "3Y",
        "description": "经营性现金流增速 > 同期20%的扣非净利润增速 3Y"
    },
    # 每股净现金流
    {
        "fields":
